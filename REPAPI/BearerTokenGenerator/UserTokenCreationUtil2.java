...
public class UserTokenCreationUtil2 {
	...
	public static void main(String[] args) {
		...
		UserTokenCreationUtil2 tokenCreation = new UserTokenCreationUtil2();
	...
	public UserTokenCreationUtil2() {

		ArrayList<TokenScope> scopeList = new ArrayList<TokenScope>();
		scopeList.add(TokenScope.IDENTITY_SCIM);
		scopeList.add(TokenScope.IDENTITY_ORGANIZATION);
