...
public class EU_UserTokenCreationUtil {
        ...
        private static final String serviceURL = "https://idbrokerbts-eu.webex.com/idb";
        ...
        public static void main(String[] args) {
                ...
                EU_UserTokenCreationUtil tokenCreation = new EU_UserTokenCreationUtil();
        ...
        public EU_UserTokenCreationUtil() {
                ...
                tokenConfig = UserTokenConfig.newBuilder()
                                ...
                                .scope(TokenScope.IDENTITY_ORGANIZATION)
        ...
        public class DefaultTokenValidatorConfig implements TokenValidatorConfig {
            private static final String DEFAULT_TOKEN_INFO_URL = "https://idbrokerbts-eu.webex.com/idb";
