...
public class UserTokenCreationUtilProd {
	...
	private static final String serviceURL = "https://idbroker.webex.com/idb";
	private static final String redirectURL = "https://rialtobeta.broadcloudpbx.net/rep/";
	...
	public static void main(String[] args) {
		...
		UserTokenCreationUtilProd tokenCreation = new UserTokenCreationUtilProd();
	...
	public UserTokenCreationUtilProd() {
	...
	public class DefaultTokenValidatorConfig implements TokenValidatorConfig {
	    private static final String DEFAULT_TOKEN_INFO_URL = "https://idbroker.webex.com/idb";
